...
- [5 Check for empty/mismatched
  FastQs](#5-check-for-emptymismatched-fastqs)
  - [5.1 Delete empty FastQs](#51-delete-empty-fastqs)
  - [5.2 Check for missing FastQ
    pairs](#52-check-for-missing-fastq-pairs)
